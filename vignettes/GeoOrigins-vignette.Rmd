...
IDbyDistanceDistInput(LatLongs = NEFtInfo[-1,2:3], 
                      ...
                      Verbose = FALSE, 
                      Validate = FALSE, 
                      PlotValCor = NEFtrThres$`Provenancing.Correlation.1%.Confidence`, 
                      PlotProv = TRUE,
                      Method = 'Spearman')
